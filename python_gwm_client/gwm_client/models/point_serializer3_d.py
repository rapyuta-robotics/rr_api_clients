...
class PointSerializer3D(BaseModel):
    """
    3D GIS point  # noqa: E501
    """
    coordinates: conlist(Union[StrictFloat, StrictInt], max_items=3, min_items=3) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PointSerializer3D:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PointSerializer3D:
        """Create an instance of PointSerializer3D from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PointSerializer3D.parse_obj(obj)

        _obj = PointSerializer3D.parse_obj({
