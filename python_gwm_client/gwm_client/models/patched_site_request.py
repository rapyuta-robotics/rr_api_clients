...
class PatchedSiteRequest(BaseModel):
    """
    PatchedSiteRequest
    """
    ...
    type: Optional[constr(strict=True, max_length=50, min_length=1)] = Field(None, description="type fo site (e.g. warehouse)")
    meta_data: Optional[Dict[str, Any]] = Field(None, description="optional JSON encoded metadata for this object")
    __properties = ["id", "name", "type", "meta_data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchedSiteRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchedSiteRequest:
        """Create an instance of PatchedSiteRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PatchedSiteRequest.parse_obj(obj)

        _obj = PatchedSiteRequest.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "type": obj.get("type"),
