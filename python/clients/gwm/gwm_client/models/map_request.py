...
class MapRequest(BaseModel):
    ...
    __properties = ["id", "name", "floor", "warnings", "num_layers", "graph_version", "meta_data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MapRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MapRequest:
        """Create an instance of MapRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MapRequest.parse_obj(obj)

        _obj = MapRequest.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "floor": obj.get("floor"),
