...
class InlineAgentTaskFragmentRequest(BaseModel):
    """
    ...
    __properties = ["work_fragment", "id", "status", "type", "quantity_requested", "quantity_delivered", "quantity_picked", "payload_data", "detection_data", "pick_data", "drop_data", "from_location", "to_location", "name", "workflow"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InlineAgentTaskFragmentRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InlineAgentTaskFragmentRequest:
        """Create an instance of InlineAgentTaskFragmentRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InlineAgentTaskFragmentRequest.parse_obj(obj)

        _obj = InlineAgentTaskFragmentRequest.parse_obj({
