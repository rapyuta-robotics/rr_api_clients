...
class SpotAnnotationExportRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SpotAnnotationExportRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SpotAnnotationExportRequest:
        """Create an instance of SpotAnnotationExportRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SpotAnnotationExportRequest.parse_obj(obj)

        _obj = SpotAnnotationExportRequest.parse_obj({
            "id": obj.get("id"),
