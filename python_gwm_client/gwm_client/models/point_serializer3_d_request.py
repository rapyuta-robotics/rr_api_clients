...
class PointSerializer3DRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PointSerializer3DRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PointSerializer3DRequest:
        """Create an instance of PointSerializer3DRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PointSerializer3DRequest.parse_obj(obj)

        _obj = PointSerializer3DRequest.parse_obj({
