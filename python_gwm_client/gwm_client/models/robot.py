...
class Robot(BaseModel):
    ...
    ip_address: Optional[StrictStr] = Field(None, description="IP address of the robot ")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Robot:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Robot:
        """Create an instance of Robot from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Robot.parse_obj(obj)

        _obj = Robot.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
