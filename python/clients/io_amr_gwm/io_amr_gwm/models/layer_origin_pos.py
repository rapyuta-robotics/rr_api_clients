...
class LayerOriginPos(BaseModel):
    """
    Origin of map  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LayerOriginPos:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LayerOriginPos:
        """Create an instance of LayerOriginPos from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LayerOriginPos.parse_obj(obj)

        _obj = LayerOriginPos.parse_obj({
