...
class InternalWorkPayloadFragmentRequestToPos(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InternalWorkPayloadFragmentRequestToPos:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InternalWorkPayloadFragmentRequestToPos:
        """Create an instance of InternalWorkPayloadFragmentRequestToPos from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InternalWorkPayloadFragmentRequestToPos.parse_obj(obj)

        _obj = InternalWorkPayloadFragmentRequestToPos.parse_obj({
