...
class V3WorkInternalUpdateRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V3WorkInternalUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V3WorkInternalUpdateRequest:
        """Create an instance of V3WorkInternalUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V3WorkInternalUpdateRequest.parse_obj(obj)

        _obj = V3WorkInternalUpdateRequest.parse_obj({
