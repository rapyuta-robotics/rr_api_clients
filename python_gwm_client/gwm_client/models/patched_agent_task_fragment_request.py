...
class PatchedAgentTaskFragmentRequest(BaseModel):
    ...
    action_location: Optional[LocationRequest] = None
    ...
    __properties = ["agent_task", "work_fragment", "id", "status", "type", "quantity_requested", "quantity_delivered", "quantity_picked", "payload_data", "detection_data", "action_data", "pick_data", "drop_data", "from_location", "to_location", "action_location", "name", "workflow"]
    ...
    def from_dict(cls, obj: dict) -> PatchedAgentTaskFragmentRequest:
        ...
        _obj = PatchedAgentTaskFragmentRequest.parse_obj({
            ...
            "action_location": LocationRequest.from_dict(obj.get("action_location")) if obj.get("action_location") is not None else None,
            "name": obj.get("name"),
