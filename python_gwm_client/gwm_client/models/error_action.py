...
class ErrorAction(BaseModel):
    ...
    description: StrictStr = Field(..., description="A description of what this error action does")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ErrorAction:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ErrorAction:
        """Create an instance of ErrorAction from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ErrorAction.parse_obj(obj)

        _obj = ErrorAction.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
