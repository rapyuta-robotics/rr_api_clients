...
class PatchedV3WorkExternalUpdateRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchedV3WorkExternalUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchedV3WorkExternalUpdateRequest:
        """Create an instance of PatchedV3WorkExternalUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PatchedV3WorkExternalUpdateRequest.parse_obj(obj)

        _obj = PatchedV3WorkExternalUpdateRequest.parse_obj({
