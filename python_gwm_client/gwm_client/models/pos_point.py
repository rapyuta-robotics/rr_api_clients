...
class PosPoint(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PosPoint:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PosPoint:
        """Create an instance of PosPoint from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PosPoint.parse_obj(obj)

        _obj = PosPoint.parse_obj({
