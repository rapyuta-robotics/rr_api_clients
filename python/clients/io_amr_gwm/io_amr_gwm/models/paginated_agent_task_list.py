...
class PaginatedAgentTaskList(BaseModel):
    """
    ...
    results: Optional[conlist(AgentTask)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedAgentTaskList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedAgentTaskList:
        """Create an instance of PaginatedAgentTaskList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedAgentTaskList.parse_obj(obj)

        _obj = PaginatedAgentTaskList.parse_obj({
            "count": obj.get("count"),
            "next": obj.get("next"),
            "previous": obj.get("previous"),
            "results": [AgentTask.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
