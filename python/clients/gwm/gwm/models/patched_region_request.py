...
class PatchedRegionRequest(BaseModel):
    """
    ...
    geom: Optional[PolygonRequest] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchedRegionRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchedRegionRequest:
        """Create an instance of PatchedRegionRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PatchedRegionRequest.parse_obj(obj)

        _obj = PatchedRegionRequest.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
