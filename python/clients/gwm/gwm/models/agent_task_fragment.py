...
class AgentTaskFragment(BaseModel):
    """
    AgentTaskFragment
    """
    ...
    work: StrictInt = Field(...)
    agent: StrictInt = Field(...)
    ...
    __properties = ["agent_task", "work_fragment", "work", "agent", "id", "status", "type", "quantity_requested", "quantity_delivered", "quantity_picked", "payload_data", "detection_data", "pick_data", "drop_data", "from_location", "to_location", "name", "workflow"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AgentTaskFragment:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AgentTaskFragment:
        """Create an instance of AgentTaskFragment from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AgentTaskFragment.parse_obj(obj)

        _obj = AgentTaskFragment.parse_obj({
