...
class PatchedAgentRequest(BaseModel):
    ...
    robot_id: Optional[conint(strict=True, le=2147483647, ge=0)] = None
    robot_descriptor_id: Optional[conint(strict=True, le=2147483647, ge=0)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchedAgentRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchedAgentRequest:
        """Create an instance of PatchedAgentRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PatchedAgentRequest.parse_obj(obj)

        _obj = PatchedAgentRequest.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
