...
class LayerRequestOriginPos(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LayerRequestOriginPos:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LayerRequestOriginPos:
        """Create an instance of LayerRequestOriginPos from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LayerRequestOriginPos.parse_obj(obj)

        _obj = LayerRequestOriginPos.parse_obj({
