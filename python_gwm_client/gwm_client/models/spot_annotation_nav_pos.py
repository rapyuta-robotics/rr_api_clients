...
class SpotAnnotationNavPos(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SpotAnnotationNavPos:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SpotAnnotationNavPos:
        """Create an instance of SpotAnnotationNavPos from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SpotAnnotationNavPos.parse_obj(obj)

        _obj = SpotAnnotationNavPos.parse_obj({
