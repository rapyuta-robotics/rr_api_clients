...
class WorkflowExecutionUpdateSerializerV1(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WorkflowExecutionUpdateSerializerV1:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WorkflowExecutionUpdateSerializerV1:
        """Create an instance of WorkflowExecutionUpdateSerializerV1 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WorkflowExecutionUpdateSerializerV1.parse_obj(obj)

        _obj = WorkflowExecutionUpdateSerializerV1.parse_obj({
            "id": obj.get("id"),
            "type": obj.get("type"),
