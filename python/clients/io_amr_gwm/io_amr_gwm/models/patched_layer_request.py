...
class PatchedLayerRequest(BaseModel):
    """
    PatchedLayerRequest
    """
    ...
    type: Optional[constr(strict=True, max_length=100, min_length=1)] = Field(None, description="Type of the layer")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchedLayerRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchedLayerRequest:
        """Create an instance of PatchedLayerRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PatchedLayerRequest.parse_obj(obj)

        _obj = PatchedLayerRequest.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "type": obj.get("type"),
            "order": obj.get("order"),
