...
class PatchedWorkExternalUpdateRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchedWorkExternalUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchedWorkExternalUpdateRequest:
        """Create an instance of PatchedWorkExternalUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PatchedWorkExternalUpdateRequest.parse_obj(obj)

        _obj = PatchedWorkExternalUpdateRequest.parse_obj({
