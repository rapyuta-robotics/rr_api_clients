...
class PatchedContainerDescriptorRequest(BaseModel):
    """
    ...
    length: Optional[Union[confloat(ge=0, strict=True), conint(ge=0, strict=True)]] = None
    width: Optional[Union[confloat(ge=0, strict=True), conint(ge=0, strict=True)]] = None
    height: Optional[Union[confloat(ge=0, strict=True), conint(ge=0, strict=True)]] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchedContainerDescriptorRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchedContainerDescriptorRequest:
        """Create an instance of PatchedContainerDescriptorRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PatchedContainerDescriptorRequest.parse_obj(obj)

        _obj = PatchedContainerDescriptorRequest.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
