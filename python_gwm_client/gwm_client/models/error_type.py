...
class ErrorType(BaseModel):
    ...
    reporting_component: StrictStr = Field(..., description="This is the reporting_component of the error")
    ...
    auto_recovery_actions: Optional[conlist(AutoRecoveryAction)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ErrorType:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ErrorType:
        """Create an instance of ErrorType from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ErrorType.parse_obj(obj)

        _obj = ErrorType.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            ...
            "auto_recovery_actions": [AutoRecoveryAction.from_dict(_item) for _item in obj.get("auto_recovery_actions")] if obj.get("auto_recovery_actions") is not None else None,
