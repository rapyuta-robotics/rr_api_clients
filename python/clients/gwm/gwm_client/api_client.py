...
import gwm_client.models
from gwm_client import rest
from gwm_client.exceptions import ApiValueError, ApiException
...
class ApiClient:
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/api-client-testing/python'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(gwm_client.models, klass)
