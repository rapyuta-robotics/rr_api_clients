...
class PatchedSpotAnnotationUpdateRequestNavPos(BaseModel):
    """
    Position for the robot to navigate to interact with the spot  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchedSpotAnnotationUpdateRequestNavPos:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchedSpotAnnotationUpdateRequestNavPos:
        """Create an instance of PatchedSpotAnnotationUpdateRequestNavPos from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PatchedSpotAnnotationUpdateRequestNavPos.parse_obj(obj)

        _obj = PatchedSpotAnnotationUpdateRequestNavPos.parse_obj({
