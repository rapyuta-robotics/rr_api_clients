...
class PaginatedWorkPayloadFragmentList(BaseModel):
    """
    ...
    results: Optional[conlist(WorkPayloadFragment)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedWorkPayloadFragmentList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedWorkPayloadFragmentList:
        """Create an instance of PaginatedWorkPayloadFragmentList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedWorkPayloadFragmentList.parse_obj(obj)

        _obj = PaginatedWorkPayloadFragmentList.parse_obj({
            "count": obj.get("count"),
            "next": obj.get("next"),
            "previous": obj.get("previous"),
            "results": [WorkPayloadFragment.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
