# openapi_client.ErrorsAppErrorTypesApi
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ErrorsAppErrorTypesApi(api_client)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.ErrorsAppErrorTypesApi(api_client)
    patched_error_type_request = openapi_client.PatchedErrorTypeRequest() # PatchedErrorTypeRequest |  (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.ErrorsAppErrorTypesApi(api_client)
    error_type_request = openapi_client.ErrorTypeRequest() # ErrorTypeRequest | 
