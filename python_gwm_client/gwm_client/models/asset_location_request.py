...
class AssetLocationRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AssetLocationRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AssetLocationRequest:
        """Create an instance of AssetLocationRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AssetLocationRequest.parse_obj(obj)

        _obj = AssetLocationRequest.parse_obj({
