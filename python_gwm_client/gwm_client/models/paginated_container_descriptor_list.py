...
class PaginatedContainerDescriptorList(BaseModel):
    """
    ...
    results: Optional[conlist(ContainerDescriptor)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedContainerDescriptorList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedContainerDescriptorList:
        """Create an instance of PaginatedContainerDescriptorList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedContainerDescriptorList.parse_obj(obj)

        _obj = PaginatedContainerDescriptorList.parse_obj({
            "count": obj.get("count"),
            "next": obj.get("next"),
            "previous": obj.get("previous"),
            "results": [ContainerDescriptor.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
