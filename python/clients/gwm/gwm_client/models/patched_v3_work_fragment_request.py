...
class PatchedV3WorkFragmentRequest(BaseModel):
    """
    ...
    parent: Optional[StrictInt] = Field(None, description="`id` of relevant related element eg: agent,map,site,spot,node,edge,external_device")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchedV3WorkFragmentRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchedV3WorkFragmentRequest:
        """Create an instance of PatchedV3WorkFragmentRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PatchedV3WorkFragmentRequest.parse_obj(obj)

        _obj = PatchedV3WorkFragmentRequest.parse_obj({
