...
class ExternalDevice(BaseModel):
    ...
    type: constr(strict=True, max_length=50) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExternalDevice:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExternalDevice:
        """Create an instance of ExternalDevice from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExternalDevice.parse_obj(obj)

        _obj = ExternalDevice.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "type": obj.get("type"),
