...
class PaginatedContainerList(BaseModel):
    """
    ...
    results: Optional[conlist(Container)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedContainerList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedContainerList:
        """Create an instance of PaginatedContainerList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedContainerList.parse_obj(obj)

        _obj = PaginatedContainerList.parse_obj({
            "count": obj.get("count"),
            "next": obj.get("next"),
            "previous": obj.get("previous"),
            "results": [Container.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
