...
class V3WorkFragmentUpdate(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V3WorkFragmentUpdate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V3WorkFragmentUpdate:
        """Create an instance of V3WorkFragmentUpdate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V3WorkFragmentUpdate.parse_obj(obj)

        _obj = V3WorkFragmentUpdate.parse_obj({
