# openapi_client.WorksAppWorkFragmentsV3Api
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.WorksAppWorkFragmentsV3Api(api_client)
    v3_work_fragment_bulk_update_request = [openapi_client.V3WorkFragmentBulkUpdateRequest()] # List[V3WorkFragmentBulkUpdateRequest] | 
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.WorksAppWorkFragmentsV3Api(api_client)
    v3_work_fragment_request = [openapi_client.V3WorkFragmentRequest()] # List[V3WorkFragmentRequest] | 
