...
class PaginatedProductList(BaseModel):
    ...
    results: Optional[conlist(Product)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedProductList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedProductList:
        """Create an instance of PaginatedProductList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedProductList.parse_obj(obj)

        _obj = PaginatedProductList.parse_obj({
            "count": obj.get("count"),
            "next": obj.get("next"),
