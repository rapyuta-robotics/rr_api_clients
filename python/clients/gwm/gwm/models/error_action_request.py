...
class ErrorActionRequest(BaseModel):
    ...
    description: constr(strict=True, min_length=1) = Field(..., description="A description of what this error action does")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ErrorActionRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ErrorActionRequest:
        """Create an instance of ErrorActionRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ErrorActionRequest.parse_obj(obj)

        _obj = ErrorActionRequest.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
