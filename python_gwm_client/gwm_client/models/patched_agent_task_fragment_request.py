...
class PatchedAgentTaskFragmentRequest(BaseModel):
    """
    PatchedAgentTaskFragmentRequest
    """
    agent_task: Optional[StrictInt] = Field(None, description="`id` of relevant related element eg: agent,map,site,spot,node,edge,external_device")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchedAgentTaskFragmentRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchedAgentTaskFragmentRequest:
        """Create an instance of PatchedAgentTaskFragmentRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PatchedAgentTaskFragmentRequest.parse_obj(obj)

        _obj = PatchedAgentTaskFragmentRequest.parse_obj({
