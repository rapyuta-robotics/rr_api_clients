...
class PatchedMapGraphUpdateRequest(BaseModel):
    """
    ...
    __properties = ["id", "name", "floor", "meta_data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchedMapGraphUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchedMapGraphUpdateRequest:
        """Create an instance of PatchedMapGraphUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PatchedMapGraphUpdateRequest.parse_obj(obj)

        _obj = PatchedMapGraphUpdateRequest.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "floor": obj.get("floor"),
