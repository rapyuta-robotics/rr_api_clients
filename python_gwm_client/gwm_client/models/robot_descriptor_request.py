...
class RobotDescriptorRequest(BaseModel):
    """
    ...
    name: constr(strict=True, max_length=100, min_length=1) = Field(..., description="Name of the robot")
    type: Optional[StrictStr] = Field(None, description="Type of robot  * `AMR` - Amr * `FORKLIFT` - Forklift")
    vendor: constr(strict=True, max_length=100, min_length=1) = Field(..., description="Name of system vendor")
    model: constr(strict=True, max_length=50, min_length=1) = Field(...)
    io_project_id: Optional[constr(strict=True, max_length=50)] = None
    labels: Dict[str, constr(strict=True, min_length=1)] = Field(...)
    meta_data: Optional[Dict[str, Any]] = Field(None, description="optional JSON encoded metadata for this object")
    footprint: Optional[PatchedRobotDescriptorRequestFootprint] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RobotDescriptorRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RobotDescriptorRequest:
        """Create an instance of RobotDescriptorRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RobotDescriptorRequest.parse_obj(obj)

        _obj = RobotDescriptorRequest.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "type": obj.get("type"),
            ...
            "footprint": PatchedRobotDescriptorRequestFootprint.from_dict(obj.get("footprint")) if obj.get("footprint") is not None else None,
