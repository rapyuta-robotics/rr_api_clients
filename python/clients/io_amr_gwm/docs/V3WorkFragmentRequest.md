...
json = "{}"
# create an instance of V3WorkFragmentRequest from a JSON string
v3_work_fragment_request_instance = V3WorkFragmentRequest.from_json(json)
# print the JSON string representation of the object
print V3WorkFragmentRequest.to_json()

# convert the object into a dict
v3_work_fragment_request_dict = v3_work_fragment_request_instance.to_dict()
# create an instance of V3WorkFragmentRequest from a dict
v3_work_fragment_request_form_dict = v3_work_fragment_request.from_dict(v3_work_fragment_request_dict)
```
