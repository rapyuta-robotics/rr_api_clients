...
class InternalWorkPayloadFragment(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InternalWorkPayloadFragment:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InternalWorkPayloadFragment:
        """Create an instance of InternalWorkPayloadFragment from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InternalWorkPayloadFragment.parse_obj(obj)

        _obj = InternalWorkPayloadFragment.parse_obj({
