...
**fragment_count** | **int** |  | [readonly] 
**terminal_fragment_count** | **int** |  | [readonly] 
**task_fragment_count** | **int** |  | [readonly] 
**terminal_task_fragment_count** | **int** |  | [readonly] 
**container_move_task_fragment_count** | **int** |  | [readonly] 
**to_spot_query_region_ids** | **List[int]** |  | [readonly] 
