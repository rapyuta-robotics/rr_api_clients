...
class NodeDbJson(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NodeDbJson:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NodeDbJson:
        """Create an instance of NodeDbJson from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NodeDbJson.parse_obj(obj)

        _obj = NodeDbJson.parse_obj({
            "id": obj.get("id"),
            "pos": obj.get("pos"),
