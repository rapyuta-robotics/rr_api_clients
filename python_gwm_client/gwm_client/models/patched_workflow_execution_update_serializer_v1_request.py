...
class PatchedWorkflowExecutionUpdateSerializerV1Request(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchedWorkflowExecutionUpdateSerializerV1Request:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchedWorkflowExecutionUpdateSerializerV1Request:
        """Create an instance of PatchedWorkflowExecutionUpdateSerializerV1Request from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PatchedWorkflowExecutionUpdateSerializerV1Request.parse_obj(obj)

        _obj = PatchedWorkflowExecutionUpdateSerializerV1Request.parse_obj({
