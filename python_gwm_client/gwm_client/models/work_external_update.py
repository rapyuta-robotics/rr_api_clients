...
class WorkExternalUpdate(BaseModel):
    """
    WorkExternalUpdate
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WorkExternalUpdate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WorkExternalUpdate:
        """Create an instance of WorkExternalUpdate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WorkExternalUpdate.parse_obj(obj)

        _obj = WorkExternalUpdate.parse_obj({
