...
class PatchedV3WorkInternalUpdateRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchedV3WorkInternalUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchedV3WorkInternalUpdateRequest:
        """Create an instance of PatchedV3WorkInternalUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PatchedV3WorkInternalUpdateRequest.parse_obj(obj)

        _obj = PatchedV3WorkInternalUpdateRequest.parse_obj({
