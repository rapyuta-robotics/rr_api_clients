# openapi_client.WorksAppAgentTaskFragmentsApi
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.WorksAppAgentTaskFragmentsApi(api_client)
    patched_agent_task_fragment_request = openapi_client.PatchedAgentTaskFragmentRequest() # PatchedAgentTaskFragmentRequest |  (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.WorksAppAgentTaskFragmentsApi(api_client)
    agent = [openapi_client.V1ContainersCreateDescriptorParameterInner()] # List[V1ContainersCreateDescriptorParameterInner] |  (optional)
    ...
    work = [openapi_client.V1ContainersCreateDescriptorParameterInner()] # List[V1ContainersCreateDescriptorParameterInner] |  (optional)
