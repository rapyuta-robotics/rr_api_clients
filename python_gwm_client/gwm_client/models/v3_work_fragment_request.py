...
class V3WorkFragmentRequest(BaseModel):
    """
    ...
    parent: StrictInt = Field(..., description="`id` of relevant related element eg: agent,map,site,spot,node,edge,external_device")
    ...
    __properties = ["meta_data", "type", "status", "rejection_reason", "from_spot", "to_spot", "from_region", "to_region", "from_pos", "to_pos", "from_yaw", "to_yaw", "from_map", "to_map", "parent", "from_spot_query", "to_spot_query", "name", "application_data", "quantity_requested", "quantity_delivered"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V3WorkFragmentRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V3WorkFragmentRequest:
        """Create an instance of V3WorkFragmentRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V3WorkFragmentRequest.parse_obj(obj)

        _obj = V3WorkFragmentRequest.parse_obj({
