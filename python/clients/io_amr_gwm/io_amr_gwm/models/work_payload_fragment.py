...
class WorkPayloadFragment(BaseModel):
    """
    WorkPayloadFragment
    """
    type: StrictStr = Field(..., description="* `ITEM_MOVE` - Item Move * `CONTAINER_MOVE` - Container Move")
    ...
    from_pos: Optional[InternalWorkPayloadFragmentToPos] = None
    to_pos: Optional[InternalWorkPayloadFragmentToPos] = None
    ...
    parent: StrictInt = Field(...)
    from_spot_query: Optional[Dict[str, Any]] = None
    to_spot_query: Optional[Dict[str, Any]] = None
    task_fragments: conlist(AgentTaskFragment) = Field(...)
    name: Optional[constr(strict=True, max_length=255)] = Field(None, description="Name")
    ...
    __properties = ["type", "id", "status", "rejection_reason", "from_spot", "to_spot", "from_region", "to_region", "from_pos", "to_pos", "from_yaw", "to_yaw", "from_map", "to_map", "parent", "from_spot_query", "to_spot_query", "task_fragments", "name", "quantity_requested", "quantity_delivered", "meta_data", "application_data", "workflow"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WorkPayloadFragment:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WorkPayloadFragment:
        """Create an instance of WorkPayloadFragment from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WorkPayloadFragment.parse_obj(obj)

        _obj = WorkPayloadFragment.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
            ...
            "from_pos": InternalWorkPayloadFragmentToPos.from_dict(obj.get("from_pos")) if obj.get("from_pos") is not None else None,
            "to_pos": InternalWorkPayloadFragmentToPos.from_dict(obj.get("to_pos")) if obj.get("to_pos") is not None else None,
            ...
            "task_fragments": [AgentTaskFragment.from_dict(_item) for _item in obj.get("task_fragments")] if obj.get("task_fragments") is not None else None,
            "name": obj.get("name"),
