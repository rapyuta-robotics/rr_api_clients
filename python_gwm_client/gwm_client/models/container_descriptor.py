...
class ContainerDescriptor(BaseModel):
    ...
    groups: Optional[conlist(constr(strict=True, max_length=64))] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContainerDescriptor:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContainerDescriptor:
        """Create an instance of ContainerDescriptor from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContainerDescriptor.parse_obj(obj)

        _obj = ContainerDescriptor.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
