...
class PatchedInternalWorkPayloadFragmentRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchedInternalWorkPayloadFragmentRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchedInternalWorkPayloadFragmentRequest:
        """Create an instance of PatchedInternalWorkPayloadFragmentRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PatchedInternalWorkPayloadFragmentRequest.parse_obj(obj)

        _obj = PatchedInternalWorkPayloadFragmentRequest.parse_obj({
