...
class V3WorkFragment(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V3WorkFragment:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V3WorkFragment:
        """Create an instance of V3WorkFragment from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V3WorkFragment.parse_obj(obj)

        _obj = V3WorkFragment.parse_obj({
