...
class SpotAnnotation(BaseModel):
    """
    SpotAnnotation
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SpotAnnotation:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SpotAnnotation:
        """Create an instance of SpotAnnotation from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SpotAnnotation.parse_obj(obj)

        _obj = SpotAnnotation.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
