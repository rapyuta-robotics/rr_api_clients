...
class AgentTaskFragment(BaseModel):
    ...
    __properties = ["agent_task", "work_fragment", "work", "agent", "id", "status", "type", "quantity_requested", "quantity_delivered", "quantity_picked", "payload_data", "detection_data", "action_data", "pick_data", "drop_data", "from_location", "to_location", "action_location", "name", "workflow"]
