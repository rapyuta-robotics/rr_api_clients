...
class NodeRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NodeRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NodeRequest:
        """Create an instance of NodeRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NodeRequest.parse_obj(obj)

        _obj = NodeRequest.parse_obj({
            "id": obj.get("id"),
