...
class PatchedV3WorkFragmentUpdateRequest(BaseModel):
    """
    ...
    __properties = ["quantity_delivered", "status", "application_data", "meta_data", "rejection_reason"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchedV3WorkFragmentUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchedV3WorkFragmentUpdateRequest:
        """Create an instance of PatchedV3WorkFragmentUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PatchedV3WorkFragmentUpdateRequest.parse_obj(obj)

        _obj = PatchedV3WorkFragmentUpdateRequest.parse_obj({
