...
class V3Work(BaseModel):
    ...
    __properties = ["id", "name", "created_at", "activated_at", "priority", "type", "status", "cut_off_time", "rejection_reason", "application_data", "workflow", "batch", "assigned_agent", "spot", "region", "map", "pos", "yaw", "meta_data", "computed_priority", "location"]
