...
class PatchedAgentTaskRequest(BaseModel):
    """
    ...
    __properties = ["agent", "required_agent", "work", "id", "status", "type", "assignment_data", "action_data", "split_data", "workflow", "priority", "location"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchedAgentTaskRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchedAgentTaskRequest:
        """Create an instance of PatchedAgentTaskRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PatchedAgentTaskRequest.parse_obj(obj)

        _obj = PatchedAgentTaskRequest.parse_obj({
            "agent": obj.get("agent"),
