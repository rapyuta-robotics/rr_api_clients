...
class PatchedRobotDescriptorRequest(BaseModel):
    """
    ...
    vendor: Optional[constr(strict=True, max_length=100, min_length=1)] = Field(None, description="Name of system vendor")
    model: Optional[constr(strict=True, max_length=50, min_length=1)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchedRobotDescriptorRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchedRobotDescriptorRequest:
        """Create an instance of PatchedRobotDescriptorRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PatchedRobotDescriptorRequest.parse_obj(obj)

        _obj = PatchedRobotDescriptorRequest.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "type": obj.get("type"),
