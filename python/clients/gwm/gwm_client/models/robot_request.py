...
class RobotRequest(BaseModel):
    ...
    robot_descriptor: StrictInt = Field(..., description="`id` of relevant related element eg: agent,map,site,spot,node,edge,external_device")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RobotRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RobotRequest:
        """Create an instance of RobotRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RobotRequest.parse_obj(obj)

        _obj = RobotRequest.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
