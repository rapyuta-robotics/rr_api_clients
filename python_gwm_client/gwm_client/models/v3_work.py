...
class V3Work(BaseModel):
    ...
    fragment_count: StrictInt = Field(...)
    terminal_fragment_count: StrictInt = Field(...)
    task_fragment_count: StrictInt = Field(...)
    terminal_task_fragment_count: StrictInt = Field(...)
    container_move_task_fragment_count: StrictInt = Field(...)
    to_spot_query_region_ids: conlist(StrictInt) = Field(...)
    meta_data: Optional[Dict[str, Any]] = Field(None, description="optional JSON encoded metadata for this object")
    computed_priority: StrictStr = Field(..., description="Effective priority computed by IO-AMR rules")
    location: Optional[Location] = None
    __properties = ["id", "name", "created_at", "activated_at", "priority", "type", "status", "cut_off_time", "rejection_reason", "application_data", "workflow", "batch", "assigned_agent", "spot", "region", "map", "pos", "yaw", "fragment_count", "terminal_fragment_count", "task_fragment_count", "terminal_task_fragment_count", "container_move_task_fragment_count", "to_spot_query_region_ids", "meta_data", "computed_priority", "location"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> V3Work:
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          exclude={
                            ...
                            "task_fragment_count",
                            "terminal_task_fragment_count",
                            "container_move_task_fragment_count",
                            "to_spot_query_region_ids",
                            "computed_priority",
                          },
                          exclude_none=True)
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> V3Work:
        """Create an instance of V3Work from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return V3Work.parse_obj(obj)

        _obj = V3Work.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            ...
            "yaw": obj.get("yaw"),
            "fragment_count": obj.get("fragment_count"),
            "terminal_fragment_count": obj.get("terminal_fragment_count"),
            "task_fragment_count": obj.get("task_fragment_count"),
            "terminal_task_fragment_count": obj.get("terminal_task_fragment_count"),
            "container_move_task_fragment_count": obj.get("container_move_task_fragment_count"),
            "to_spot_query_region_ids": obj.get("to_spot_query_region_ids"),
            "meta_data": obj.get("meta_data"),
            "computed_priority": obj.get("computed_priority"),
