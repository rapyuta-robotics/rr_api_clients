...
class PaginatedAssetLocationList(BaseModel):
    """
    ...
    results: Optional[conlist(AssetLocation)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedAssetLocationList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedAssetLocationList:
        """Create an instance of PaginatedAssetLocationList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedAssetLocationList.parse_obj(obj)

        _obj = PaginatedAssetLocationList.parse_obj({
            "count": obj.get("count"),
            "next": obj.get("next"),
            "previous": obj.get("previous"),
            "results": [AssetLocation.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
