...
class PatchedSchemaRequest(BaseModel):
    """
    ...
    field_name: Optional[constr(strict=True, max_length=50, min_length=1)] = Field(None, description="The field on the given resource that this schema applies to (default: 'meta_data').")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchedSchemaRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchedSchemaRequest:
        """Create an instance of PatchedSchemaRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PatchedSchemaRequest.parse_obj(obj)

        _obj = PatchedSchemaRequest.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "type": obj.get("type"),
