...
class PatchedProductRequest(BaseModel):
    ...
    product_id: Optional[constr(strict=True, max_length=200, min_length=1)] = Field(None, description="Identification key for the product.")
    name: Optional[constr(strict=True, max_length=200, min_length=1)] = Field(None, description="Name for the product")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchedProductRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchedProductRequest:
        """Create an instance of PatchedProductRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PatchedProductRequest.parse_obj(obj)

        _obj = PatchedProductRequest.parse_obj({
